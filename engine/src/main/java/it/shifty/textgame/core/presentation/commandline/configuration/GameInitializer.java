...
import it.shifty.textgame.core.engine.gameobjects.*;
import it.shifty.textgame.core.engine.map.Key;
import it.shifty.textgame.core.engine.map.MapEngine;
import it.shifty.textgame.core.engine.map.Room;
import it.shifty.textgame.core.engine.map.RoomClosedWithKey;
...
import static it.shifty.textgame.core.engine.gameobjects.GlobalParameters.DEFAULT_ARMOR_HEALTH;
import static it.shifty.textgame.core.engine.gameobjects.GlobalParameters.DEFAULT_DAMAGE_WEAPON;
